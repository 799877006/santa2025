// sa_runner.cpp
// g++ -O3 -std=c++17 -Xpreprocessor -fopenmp -I/opt/homebrew/opt/libomp/include -L/opt/homebrew/opt/libomp/lib -lomp -march=native sa_runner_original.cpp -o sa_runner.exe
#include <iostream>
#include <vector>
#include <string>
#include <fstream>
...
static SAResult run_sa_group(
    ...
    ld gravity_w = small ? 1e-4L : 1e-4L;
